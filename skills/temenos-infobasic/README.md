...
| Artifact | Path |
|----------|------|
| Skill folder | `C:\Users\Lenovo\.claude\skills\temenos-infobasic\` |
| Packaged file | `C:\Users\Lenovo\.claude\skills\temenos-infobasic\temenos-infobasic.skill` |
...
(`C:\Users\Lenovo\.claude\skills\temenos-infobasic\`). No further setup is needed —
it activates automatically when you mention T24/Infobasic keywords.

To share the skill with another machine or team member, copy `temenos-infobasic.skill`
...
```
C:\Users\Lenovo\.claude\skills\temenos-infobasic\
