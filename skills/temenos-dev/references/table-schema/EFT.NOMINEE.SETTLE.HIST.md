# EFT.NOMINEE.SETTLE.HIST — Table Schema

> Source: `INSERTS/I_F.EFT.NOMINEE.SETTLE.HIST` in `CAEFPA_EFTPap.jar` (positions/aliases via `pipeline/insert_parse.py`); type/mandatory/description via `pipeline/html_parse.py` from JavaDoc HTML.
