# temenos-jbc Skill — Developer Reference
...
Type `/temenos-jbc` followed by your request. The skill detects whether you want to **develop** new code, **customise** existing code, or **review/debug** a routine.

```
/temenos-jbc Create a REST GET API that returns loan details for a given loan ID
/temenos-jbc Add a dateOpened field to the existing GetAccountDetails component
/temenos-jbc Review this .b file and tell me why it always returns an empty response
```
...
**Prompt:**
```
/temenos-jbc Review this .b file. The REST endpoint calls it successfully
...
**Prompt:**
```
/temenos-jbc Debug this loop. It only ever builds one entry in outRecord
...
**Prompt:**
```
/temenos-jbc Review this .component file for correctness.
...
**Prompt:**
```
/temenos-jbc Review this implementation file before I deploy it to UAT.
[paste .b file]
```
...
```
/temenos-jbc Generate only the .component file, I will write the .b myself.
/temenos-jbc Generate only the .b implementation, here is the existing .component: [paste]
/temenos-jbc Generate only the .complex DTO file for this response schema: [describe fields]
```
...
```
/temenos-jbc Review this .complex file for correctness.
[paste .complex file]
```
